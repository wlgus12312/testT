...
public class LookupTable2 {
	...
	public LookupTable2() {
	 ...
	 System.out.println(hexaTable);
		
		
	}

	public String[] getHexaTable() {
		return hexaTable;
	}

	public void setHexaTable(String[] hexaTable) {
		this.hexaTable = hexaTable;
	}

	@Override
	public String toString() {
		return "LookupTable2 [hexaTable=" + Arrays.toString(hexaTable) + "]";
	}
